...
import '../features/account/presentation/store_theme_provider.dart';
...
class EverydayStoreApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final preset = ref.watch(storeThemePresetProvider);
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      title: 'Everyday Store',
      theme: buildStoreTheme(Brightness.light, preset),
      darkTheme: buildStoreTheme(Brightness.dark, preset),
      ...
      onGenerateRoute: (settings) {
        ...
        final child = switch (settings.name) {
          ProductDetailScreen.routeName when id is String =>
